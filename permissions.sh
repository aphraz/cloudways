...
find /home/master/applications/$i/public_html/ -type d -not -perm 775 -exec chmod 775 {} \;\
find /home/master/applications/$i/public_html -type f -not -perm 664 -exec chmod 664 {} \;; done
